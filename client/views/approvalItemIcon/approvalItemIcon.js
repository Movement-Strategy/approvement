Template['approvalItemIcon'].helpers({
	popup_content : function() {
		var content = popupContent.getContent(this.type, this.content_type, this.contents, this).content;
		var that = this;
	...
	popup_title : function() {
		return popupContent.getContent(this.type, this.content_type, this.contents, this).title;
	},
	label_id : function() {
		return this._id;
	},
...
Template['approvalItemIcon'].events({
	'click' : function() {
		approvalItemBuilder.onEditApprovalItem(this);
	},
